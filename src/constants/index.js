...
export const PROJECTS = [
  {
    title: 'Cypress Utility Framework',
    description: 'A comprehensive utility framework for Cypress testing with 25+ advanced UI utility methods. Features smart waiting utilities, element state validation, clipboard operations, keyboard shortcuts, and professional testing capabilities for enhanced automation workflows. Published as NPM package with 3+ weekly downloads.',
    tech: ['Cypress', 'TypeScript', 'UI Utilities', 'Test Automation', 'Smart Waiting', 'Element Validation'],
    github: 'https://github.com/Karmit2196/cypress-utility-framework',
    npm: 'https://www.npmjs.com/package/cypress-utils-framework'
  },
  {
  ...
  
  {
    ...
    description: 'A robust API testing framework built with Playwright for comprehensive API validation and testing. Features request/response handling, data-driven testing, and integration with modern CI/CD pipelines for reliable API testing workflows.',
    tech: ['Playwright', 'API Testing', 'TypeScript', 'CI/CD', 'Data-driven Testing', 'Request Validation'],
    github: 'https://github.com/Karmit2196/playwright-api'
  }
];
